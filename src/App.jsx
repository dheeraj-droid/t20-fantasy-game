...
const FANTASY_ROSTERS = {
  ...
  "Group 2": ["Virat Kohli", "Surya Kumar Yadav", "Ishan Kishan", "Jasprit Bumrah", "Phil Salt", "Priyansh Arya", "Abhishek Porel", "Akash Madhwal", "Dasun Shanaka", "Mayank Yadav", "Mukesh Kumar", "Digvesh Singh", "Aniket Verma", "Kagiso Rabada", "Nuwan Tushara", "Mangesh Yadav", "Kartik Sharma", "Glenn Phillips", "Vyshak Vijaykumar", "Liam Livingstone", "Cooper Connolly", "Finn Allen"],
