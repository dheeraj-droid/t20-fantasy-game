...
const Squads = {
  ...
  "DC": [
    { name: "KL Rahul", role: "WK", isOverseas: false }, { name: "Rehan Ahmed", role: "BOWL", isOverseas: true }, { name: "Abhishek Porel", role: "WK", isOverseas: false }, { name: "Tristan Stubbs", role: "WK", isOverseas: true },
  ...
  "GT": [
    { name: "Jos Buttler", role: "BAT", isOverseas: true }, { name: "Kumar Kushagra", role: "WK", isOverseas: false }, { name: "Anuj Rawat", role: "WK", isOverseas: false }, { name: "Connor Esterhuizen", role: "WK", isOverseas: true },
  ...
  "MI": [
    ...
    { name: "Hardik Pandya", role: "AR", isOverseas: false }, { name: "Will Jacks", role: "AR", isOverseas: true }, { name: "Keshav Maharaj", role: "BOWL", isOverseas: true }, { name: "Shardul Thakur", role: "AR", isOverseas: false }, { name: "Naman Dhir", role: "AR", isOverseas: false }, { name: "Corbin Bosch", role: "AR", isOverseas: true }, { name: "Raj Angad Bawa", role: "AR", isOverseas: false }, { name: "Krish Bhagat", role: "BOWL", isOverseas: false }, { name: "Mayank Rawat", role: "AR", isOverseas: false }
  ],
  "PBKS": [
  ...
  "RCB": [
    ...
    { name: "Josh Hazlewood", role: "BOWL", isOverseas: true }, { name: "Bhuvneshwar Kumar", role: "BOWL", isOverseas: false }, { name: "Yash Dayal", role: "BOWL", isOverseas: false }, { name: "RIchard Gleeson", role: "BOWL", isOverseas: true }, { name: "Rasikh Dar", role: "BOWL", isOverseas: false }, { name: "Suyash Sharma", role: "BOWL", isOverseas: false }, { name: "Jacob Duffy", role: "BOWL", isOverseas: true }, { name: "Abhinandan Singh", role: "BOWL", isOverseas: false },
...
const FANTASY_ROSTERS = {
  ...
  "Group 2": ["Virat Kohli", "Surya Kumar Yadav", "Ishan Kishan", "Jasprit Bumrah", "Phil Salt", "Priyansh Arya", "Abhishek Porel", "Akash Madhwal", "Dasun Shanaka", "Mayank Yadav", "Mukesh Kumar", "Digvesh Singh", "Aniket Verma", "Kagiso Rabada", "RIchard Gleeson", "Mangesh Yadav", "Kartik Sharma", "Glenn Phillips", "Vyshak Vijaykumar", "Liam Livingstone", "Cooper Connolly", "Finn Allen"],
