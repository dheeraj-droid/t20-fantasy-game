...
const Squads = {
  ...
  "SRH": [
    ...
    { name: "Abhishek Sharma", role: "BAT", isOverseas: false }, { name: "Nitish Kumar Reddy", role: "BAT", isOverseas: false }, { name: "Harshal Patel", role: "AR", isOverseas: false }, { name: "Liam Livingstone", role: "AR", isOverseas: true }, { name: "Kamindu Mendis", role: "AR", isOverseas: true }, { name: "Dilshan Madushanka", role: "AR", isOverseas: true }, { name: "David Payne", role: "AR", isOverseas: true }, { name: "Harsh Dubey", role: "AR", isOverseas: false }, { name: "Shivang Kumar", role: "AR", isOverseas: false }, { name: "Krains Fuletra", role: "AR", isOverseas: false }
  ]
};
